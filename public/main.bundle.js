...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_searchresult_searchresult_component__ = __webpack_require__("../../../../../src/app/components/searchresult/searchresult.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_history_history_component__ = __webpack_require__("../../../../../src/app/components/history/history.component.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_4__components_searchresult_searchresult_component__["a" /* SearchresultComponent */],
            __WEBPACK_IMPORTED_MODULE_5__components_history_history_component__["a" /* HistoryComponent */],
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_10__services_api_service__["a" /* ApiService */]],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_history_history_component__ = __webpack_require__("../../../../../src/app/components/history/history.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_searchresult_searchresult_component__ = __webpack_require__("../../../../../src/app/components/searchresult/searchresult.component.ts");
...
var appRoutes = [
    {
        path: 'history',
        component: __WEBPACK_IMPORTED_MODULE_1__components_history_history_component__["a" /* HistoryComponent */]
    },
    {
        path: 'searchresult',
        component: __WEBPACK_IMPORTED_MODULE_2__components_searchresult_searchresult_component__["a" /* SearchresultComponent */]
    },
    {
        path: '',
...
module.exports = "<div class=\"row\">\n  <span *ngFor=\"let item of items\">\n    <div (click)=\"GetSelectedItem(item)\" class=\"section z-depth-2\" style=\"cursor:pointer\">\n      <h5 class=\"center\">{{item}}</h5>\n    </div>\n    <div class=\"divider\"></div>\n  </span>\n</div>"
...
var HistoryComponent = (function () {
    function HistoryComponent(Api, router) {
        this.Api = Api;
        this.router = router;
    }
    HistoryComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.Api.getAllKeywords().subscribe(function (x) {
            _this.items = x.KeyList;
        });
    };
    HistoryComponent.prototype.GetSelectedItem = function (item) {
...
module.exports = "<nav>\n  <div class=\"nav-wrapper purple darken-4\">\n    <a href=\"#\" class=\"brand-logo\">Image Search</a>\n    <ul id=\"nav-mobile\" class=\"right hide-on-med-and-down\">\n      <li [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a [routerLink]=\"['/']\">Home</a></li>\n      <li [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a [routerLink]=\"['/history']\">History</a></li>\n    </ul>\n  </div>\n</nav>\n<!-- <div class=\"progress\">\n  <div class=\"indeterminate\"></div>\n</div> -->"
...
var SearchresultComponent = (function () {
    function SearchresultComponent(Api, router) {
        this.Api = Api;
        this.router = router;
    }
    ...
    SearchresultComponent.prototype.GetImage = function () {
        var _this = this;
        if (this.item == '') {
            return false;
        }
...
var ApiService = (function () {
    function ApiService(_http) {
        this._http = _http;
        this.item = new __WEBPACK_IMPORTED_MODULE_3_rxjs_BehaviorSubject__["BehaviorSubject"]('');
        this.currentitem = this.item.asObservable();
        this.apiPath = '/api/';
    }
    ApiService.prototype.ChangeItem = function (item) {
        this.item.next(item);
    };
    ApiService.prototype.getAllKeywords = function () {
        return this._http.get(this.apiPath + 'getAll').map(function (x) { return x.json(); });
    };
    ApiService.prototype.getPastKeywordImage = function (item) {
        var body = {
            keyword: item
        };
        return this._http.post(this.apiPath + 'getSavedImages', body).map(function (x) { return x.json(); });
    };
    ApiService.prototype.SaveSearchResult = function (item) {
        var body = {
            keyword: item
        };
        return this._http.post(this.apiPath + 'getImageByKey', body).map(function (x) { return x.json(); });
    };
    return ApiService;
}());
